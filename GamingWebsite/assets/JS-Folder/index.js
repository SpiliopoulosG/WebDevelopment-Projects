...
let game_on = document.querySelector(".mainButton a span i");
let body = document.querySelector("body");
let keep_button_on = document.querySelector("#keep_button_on");
...
game_on.addEventListener("click", (e) => {
  game_on.innerHTML = "ON";
});

$(".mainButton a").click(function() {
  $(".hiddenContent").removeClass("no-appear");
  $(".mainButton a span").css('color', 'rgba(255, 255, 255, 1)');
  $(".main").attr('id', 'new-main');
});
...
$(window).load(function() {
  ...
  function smokeeffect() {
    ...
    //close modal window
    modalWindow.on('click', '.auto-close', function(event) {
      event.preventDefault();
